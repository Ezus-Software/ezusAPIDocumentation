...
```javascript
const ezus = require("kittn");

let api = ezus.authorize("ApiKey");
```
...
| --------------- | ---------------------------------------- |
| X_API-KEY       | edVWJpyt6z3czzBhxPpLb6hKRdx2qRQ25v6iq8SI |

| Query Params | Description                                                    |
| ------------ | -------------------------------------------------------------- |
| X_API-KEY    | edVWJpyt6z3czzBhxPpLb6hKRdx2qRQ25v6iq8SI                       |
| Body         | { "email": "youremail@email.com", "password": "yourpassword",} |
