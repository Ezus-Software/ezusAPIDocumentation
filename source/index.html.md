...
| alternative_order | String | Specifies the alternative order in the project to retrieve activities from. If not provided, defaults to `0` for main alternative. This field is <span class="label label-red float-right">Required</span> to create an activity. This field is ignored on update. |
