...
| date                       | String | Date of the payment, in a "YYYY-MM-DD" format. Must be a date between years 2000 and 2050 (exclusive), otherwise an error is returned.                                                                                                  |
| amount                     | Number | Amount of the payment. The value is rounded to 2 decimals before being stored. If the provided value is not a number, an error is returned.                                                                                             |
