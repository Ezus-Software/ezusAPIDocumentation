...
- Owner not found → `user must be the email of an active user of the account`
...
| vat_number     | String | VAT number of the client (only for "enterprise" clients)                                                                                                                                                                                                                                                         |
| company_number | String | Company registration number of the client (only for "enterprise" clients)                                                                                                                                                                                                                                        |
| user           | Email  | Email of an active Ezus user of your account, set as the owner of the client. An unknown email, or the email of a deleted or deactivated user, is rejected.                                                                                                                                                      |
